...
///////////////////////////////////////////////////////////// Do not touch below /////////////////////////////////////////
	...
	$('#verify').focusout(function() {
		...
		if (!verify)
			...
			$.ajax({
				type: 'POST',
				url: 'http://envato.jigowatt.co.uk/code/html5_contact_form/assets/js/classes/ajax_check.php',
				data: { verify: verify },
				async: false,
	...
	$('#contactform').submit(function(){
		...
		var action = $(this).attr('action');
 		...
 		$('#submit')
			.after('<img src="assets/img/ajax-loader.gif"/*tpa=http://envato.jigowatt.co.uk/code/html5_contact_form/assets/js/assets/img/ajax-loader.gif*/ class="loader" />')
